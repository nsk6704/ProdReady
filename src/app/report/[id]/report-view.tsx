...
const CHECKS: CheckItem[] = [
  ...
  { id: "has-validation", archetypes: ["web-app", "api-server", "fullstack"], label: "Input validation", howItWorks: "User input should never be trusted blindly. Validation ensures data is safe and correctly formatted." },
  ...
  { id: "has-retry-handling", archetypes: ["web-app", "api-server", "fullstack"], label: "HTTP retry & timeout handling", howItWorks: "Network requests can fail. Retry logic and timeouts prevent transient failures from crashing your application." },
